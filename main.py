...
headingFrame = Frame(wn,bg="white",bd=5)
headingFrame.place(relx=0.1,rely=0.05,relwidth=0.7,relheight=0.1)
headingLabel = Label(headingFrame, text="Generate QR Code ", bg='white', font=('Times',20,'bold'))
...
label1 = Label(Frame1,text="enter id number: ",bg="black",fg='azure',font=('Courier',13,'bold'))
